  ...
  componentDidUpdate(prevProps, prevState, snapshot) {
    ...
    if (
      ...
      this.setState({
        ...
        id_category:
          arrCategory && arrCategory.length > 0 ? arrCategory[0].id : "",
      });
    }
    if (
      ...
      this.setState({
        ...
        id_promotion:
          arrPromotion && arrPromotion.length > 0 ? arrPromotion[0].id : "",
      });
    }
  }
                ...
                <Col sm="12">
                  <Form.Group>
                    ...
                    <textarea
                      ...
                      placeholder="Mô tả..."
                      onChange={(e) => {
                        this.onChange(e, "txtDescription");
                      }}
                      rows="8"
                      required
                    ></textarea>
