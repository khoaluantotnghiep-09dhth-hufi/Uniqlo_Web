          ...
          <Row>
            ...
            <div id="companyMain">
              <div className="titCompany clearfix">
                <h1 className="tit"><img src="https://www.uniqlo.com/vn/img/tit_company_accessibility.gif" alt="KHẢ NĂNG TRUY CẬP"/></h1>
              </div>
              ...
              <h2 className="tittype02"><img src="https://www.uniqlo.com/vn/img/txt_company_accessibility.gif" alt="Hệ điều hành và trình duyệt" className="tit"/><a href="#top"><img src="https://www.uniqlo.com/vn/img/btn_pagetop02.gif" alt="" width="21" height="21" className="pagetop"/></a></h2>
              ...
              <h2 className="tittype02 clear"><img src="https://www.uniqlo.com/vn/img/txt_company_accessibility2.gif" width="93" height="21" alt="Javascript" className="tit"/><a href="#top"><img src="https://www.uniqlo.com/vn/img/btn_pagetop02.gif" alt="" width="21" height="21" className="pagetop"/></a></h2>
              <div className="boxCompanyBasic">
              ...
              <h2 className="tittype02"><img src="https://www.uniqlo.com/vn/img/txt_company_accessibility3.gif" width="68" height="17" alt="Cookies" className="tit"/><a href="#top"><img src="https://www.uniqlo.com/vn/img/btn_pagetop02.gif" alt="" width="21" height="21" className="pagetop"/></a></h2>
              <div className="boxCompanyBasic">
