        ...
        <Container>
          <Row>
            ...
            <div id="companyMain">
              ...
              <h2 className="tittype02"><img src="https://www.uniqlo.com/vn/img/txt_company_accessibility.gif" alt="Hệ điều hành và trình duyệt" className="tit"/><a href="#top"><img src="https://freepngimg.com/thumb/web_design/24723-7-up-arrow-clipart.png" alt="" width="40rem" height="40rem" className="pagetop"/></a></h2><br/>
              ...
              <h2 className="tittype02"><img src="https://www.uniqlo.com/vn/img/txt_company_accessibility2.gif" alt="Javascript" className="tit"/><a href="#top"><img src="https://freepngimg.com/thumb/web_design/24723-7-up-arrow-clipart.png" alt="" width="40rem" height="40rem" className="pagetop"/></a></h2><br/>
              <div className="boxCompanyBasic">
              ...
              <h2 className="tittype02"><img src="https://www.uniqlo.com/vn/img/txt_company_accessibility3.gif" alt="Cookies" className="tit"/><a href="#top"><img src="https://freepngimg.com/thumb/web_design/24723-7-up-arrow-clipart.png" alt="" width="40rem" height="40rem" className="pagetop"/></a></h2><br/>
              <div className="boxCompanyBasic">
