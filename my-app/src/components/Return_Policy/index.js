            ...
            <Col xs="8" sm="8" md="8" lg="8">
              <div id="companyMain">
                <div className="titCompany clearfix">
                    <h1 className="tit"><img src="https://www.uniqlo.com/vn/img/tit_company_returnpolicy.gif" alt="Chính sách đổi trả"/></h1>
                </div>
                <h2 className="tittype02"><img src="https://www.uniqlo.com/vn/img/200318_txt_company_returnpolicy.gif" alt="CHÍNH SÁCH ĐỔI TRẢ SẢN PHẨM (EXCHANGE &amp; RETURN POLICY)" className="tit"/><a href="#top"><img src="https://www.uniqlo.com/vn/img/btn_pagetop02.gif" alt="" width="21" height="21" className="pagetop"/></a></h2>
                ...
                <ol>
                  ...
                  <li><strong>Nếu sản phẩm có lỗi do sản xuất/If Product is found with manufacturing defects:</strong>
                ...
                <ol className="returnpolicy_list">
                  <li>UNIQLO Việt Nam có quyền đưa ra quyết định sau cùng về việc đổi, trả và điều chỉnh Chính sách này tại bất cứ thời điểm nào mà không cần ban hành thông báo.</li>
                  <li>UNIQLO Viet Nam reserves the right to make a final decision and to change this Policy anytime without notice.</li>
                </ol>
                </div>
              </div>
            </Col>
