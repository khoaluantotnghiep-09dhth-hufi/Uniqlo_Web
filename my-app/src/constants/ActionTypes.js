...
// product admin
export const FETCH_PRODUCTADMIN = 'FETCH_PRODUCTADMIN';
export const ADD_PRODUCTADMIN = 'ADD_PRODUCTADMIN';
export const UPDATE_PRODUCTADMIN = 'UPDATE_PRODUCTADMIN';
export const DELETE_PRODUCTADMIN = 'DELETE_PRODUCTADMIN';
export const EDIT_PRODUCTADMIN = 'EDIT_PRODUCTADMIN';
//order
export const FETCH_ORDERIMPORT = 'FETCH_ORDERIMPORT';
...
//order info
export const FETCH_ORDERINFOTOIMPORT = 'FETCH_ORDERINFOTOIMPORT';
...
//exchange product
export const FETCH_BILLINFOEXCHANGE = ' FETCH_BILLINFOEXCHANGE';
...
export const UPDATE_POSITION_BY_STAFF = 'UPDATE_POSITION_BY_STAFF';
...
export const EDIT_PRODUCTINFO = 'EDIT_PRODUCTINFO';
...
//Get import product
export const FETCH_IMPORTPRODUCT = 'FETCH_IMPORTPRODUCT';
export const ADD_IMPORTPRODUCT = 'ADD_IMPORTPRODUCT';
export const UPDATE_IMPORTPRODUCT = 'UPDATE_IMPORTPRODUCT';
export const DELETE_IMPORTPRODUCT = 'DELETE_IMPORTPRODUCT';
export const EDIT_IMPORTPRODUCT = 'EDIT_IMPORTPRODUCT';

//Get import info
export const FETCH_IMPORTINFO = 'FETCH_IMPORTINFO';
export const ADD_IMPORTINFO = 'ADD_IMPORTINFO';
export const UPDATE_IMPORTINFO = 'UPDATE_IMPORTINFO';
export const DELETE_IMPORTINFO = 'DELETE_IMPORTINFO';
export const EDIT_IMPORTINFO = 'EDIT_IMPORTINFO';
